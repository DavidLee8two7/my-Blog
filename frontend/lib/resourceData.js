  ...
  resources: [
    {
      ...
      subject: "VS Code",
      message: "I've switched from Atom. VS Studio IDE is also good."
    },
    {
      image: "/static/logo/vscode.png",
      src: "https://github.com/DavidLee8two7/resources/blob/master/README.md",
      subject: "Visual Studio Code Setup",
      message: "My VS code setting JSON file."
    },
    {
      image: "/static/logo/codepen.png",
      src: "https://codepen.io/",
      subject: "Code Pen",
      message: "Test out some codes."
    },
    {
      image: "/static/logo/emmet.png",
      src: "https://docs.emmet.io/cheat-sheet/",
      subject: "Emmet Cheat Sheet",
      message:
        "Emmet plug-ins for HTML, XML, XSL, and other structured code formats."
    }
  ]
};
  ...
  resources: [
    {
      ...
      message: "MDN is one of the most reliable source for me."
    },
    {
      image: "/static/logo/glyphs.png",
      src: "https://css-tricks.com/snippets/html/glyphs/",
      subject: "HTML glyphs",
      message: "CSS-Tricks is another reliable source."
    },
    {
      image: "/static/logo/html.png",
      src: "http://www.simplehtmlguide.com/cheatsheet.php",
      subject: "HTML Cheat Sheet",
      message: "Cheat Sheet for HTML Tags."
    }
  ]
};
  ...
  resources: [
    {
      ...
      subject: "CSS reference",
      message: "MDN reference for CSS."
    },
    {
      image: "/static/logo/cssdog.png",
      src: "http://htmldog.com/references/css/selectors/",
      subject: "CSS Selectors",
      message: "List of CSS selectors."
    },
    {
      image: "/static/logo/canicss.png",
      src: "https://caniuse.com/",
      subject: "Browser support check",
      message: "Up-to-date browser support check for frontend technologies."
    },
    {
      image: "/static/logo/grid.png",
      src: "http://www.responsivegridsystem.com/",
      subject: "Responsive grid System",
      message: "To create a responsive web site."
    },
    {
      image: "/static/logo/flexbox.jpg",
      src: "https://yoksel.github.io/flex-cheatsheet/",
      subject: "Flexbox cheat sheet",
      message: "Flexbox grid system cheat sheet."
    },
    {
    ...
    },
    {
      ...
      message: "Visually generating cubic-bezier calculator."
    },
    {
      image: "/static/logo/easings.png",
      src: "https://easings.net/",
      subject: "Collection of easing functions ",
      message: "Easing functions calculator."
    },
    {
      ...
      message:
        "Color-hex gives information about colors (RGB,HSL,HSV and CMYK)."
    }
  ]
};
  ...
  resources: [
    {
      ...
      message: "MDN reference for JavaScript."
    },
    {
      image: "/static/logo/mdn.png",
      src: "https://developer.mozilla.org/en-US/docs/Web/Events",
      subject: "JavaScript Event Reference",
      message: "JavaScript DOM events."
    },
    {
      image: "/static/logo/mdn.png",
      src:
        "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Operator_Precedence",
      subject: "JavaScript Operator Reference",
      message: "JavaScript operator precedence."
    },
    {
      image: "/static/logo/domReference.png",
      src: "http://youmightnotneedjquery.com/",
      subject: "DOM Manipulation Reference",
      message: "List of things you can do in jQuery with Vanilla JavaScript."
    },
    {
      image: "/static/logo/wes.png",
      src: "https://keycode.info/",
      subject: "JavaScript KeyCodes",
      message: "Get keyboard codes, unicodes."
    },
    {
      image: "/static/logo/es6.png",
      src: "https://kangax.github.io/compat-table/es6/",
      subject: "ES6 Browser Compatibility table",
      message: "It has all the new ES2015/ES6 features."
    },
    {
      image: "/static/logo/javascript.png",
      src: "https://github.com/rwaldron/idiomatic.js",
      subject: "Principles of Writing Consistent, Idiomatic JavaScript",
      message: "Style guide to write better code organized by open sources."
    }
  ]
};
  ...
  resources: [
    {
      ...
      message: "Beautiful color palettes."
    },
    {
    ...
    },
    {
      ...
      subject: "Paletton",
      message: "Create color combinations that play well together."
    },
    {
    ...
    },
    {
      ...
      message: "Color gradients."
    },
    {
      image: "/static/logo/0to255.png",
      src: "http://www.0to255.com/",
      subject: "0to255",
      message: "Variations of any color."
    }
  ]
};
...
const imagesAndVidoes = {
  resources: [
    ...
    },
    {
      ...
      subject: "Pixaby",
      message: "Free stock photos, vectors and art illustrations."
    },
    {
      image: "/static/logo/subtlepatterns.png",
      src: "https://www.toptal.com/designers/subtlepatterns/",
      subject: "Subtle Patterns",
      message: "High quality resource of tilable textured patterns."
    },
    {
    ...
    },
    {
      ...
      subject: "Canva",
      message: "Create designs with drag-and-drop features and layouts."
    },
    {
      image: "/static/logo/ImageOpt.gif",
      src: "http://www.imageoptimizer.net/Home.aspx",
      subject: "Image Optimizer",
      message: "Resize, compress and optimize image files."
    }
  ]
};
...
const iconsAndOthers = {
  resources: [
    ...
    },
    {
      ...
      subject: "Fontastic",
      message: "Create a customized icon font."
    },
    {
      image: "/static/logo/flaticon.png",
      src: "https://www.flaticon.com/",
      subject: "Flaticon",
      message: "Free icons available in PNG, SVG, EPS and PSD."
    },
    {
      image: "/static/logo/fontawesome.ico",
      src: "https://fontawesome.com/?from=io",
      subject: "Font Awesome",
      message: "Popular icon font,icons spread across several categories."
    },
    {
