const data = {
  resources: [
    ...
    },
    {
      ...
      message:
        "Check out exactly what theme. its good.ecome an essential tool for me to qui"
    },
    {
  ...
  resources: [
    {
      ...
      subject: "VS Code",
      message:
        "I've switched from Atom. I find it more comfortable and there are many good extensions available."
    },
    {
      image: "/static/logo/vscode.png",
      ...
      subject: "My Visual Studio Code Setup",
      message:
        "Here is my VS setting JSON just for reference. I find it useful to have different color scheme for frontend and backend or between different windows."
    },
    {
      image: "/static/logo/codepen.png",
      src: "https://codepen.io/",
      subject: "Code Pen",
      message:
        "Codepen comes handy to quickly test out some codes before making changes to your code structure."
    },
    {
      image: "/static/logo/emmet.png",
      src: "https://docs.emmet.io/cheat-sheet/",
      subject: "Emmet Cheat Sheet",
      message:
        "Emmet plug-ins makes coding  not only faster but more pleasant for HTML, XML, XSL, and other structured code formats via content assist."
    }
  ]
};
  ...
  resources: [
    {
      ...
      message:
        "MDN is one of the most reliable source for me. My  I think google search engine works better for searching something from MDN than MDN's own search engine."
    },
    {
      image: "/static/logo/glyphs.png",
      src: "https://css-tricks.com/snippets/html/glyphs/",
      subject: "HTML glyphs",
      message: "CSS-Tricks is another reliable source including HTML Glyphs."
    },
    {
      image: "/static/logo/html.png",
      src: "http://www.simplehtmlguide.com/cheatsheet.php",
      subject: "HTML Cheat Sheet",
      message: "Here is a cheat Sheet for HTML Tags."
    }
  ]
};
  ...
  resources: [
    {
      ...
      message:
        "MDN reference for CSS. I also recommand to use code snippets on your code editor."
    },
    {
      image: "/static/logo/cssdog.png",
      src: "http://htmldog.com/references/css/selectors/",
      subject: "CSS Selectors",
      message: "List of most used CSS selectors"
    },
    {
  ...
  resources: [
    {
      ...
      message:
        "MDN reference for JavaScript. I also recommand to use code snippets on your code editor."
    },
    {
      image: "/static/logo/mdn.png",
    ...
    },
    {
      ...
      message: "MDN reference for JavaScript operator precedence."
    },
    {
    ...
    },
    {
      ...
      message:
        "Get keyboard codes, unicodes. Good reference for keypress event handing."
    },
    {
      ...
      message:
        "It has all the new ES2015/ES6 features supported by the most popular browsers."
    },
    {
      ...
      message:
        "I think it's good to have a style guide to write better code organized by open sources."
    }
  ]
};
